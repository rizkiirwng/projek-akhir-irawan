<?php
require 'koneksi.php';
$all_data = query("SELECT * FROM masjid");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <div id="beranda"></div>
  <div class="nav">
    <img src="img/foto-logo-wikrama.png" alt="">
  ...
  <div class="content-utama">
    ...
    <img src="img/deskr-masjid.png" alt="">
  </div>
  <br><br><br>
  </head>
  ...
  <body>
    <div class="card-2">
      <div class="section-2">
        ...
        <div>
          ...
          <div class="value-2" id="total-dana">
            ...
            $total_dana = 0;
            $tota_harus = 1000;
            $query = "SELECT nominal FROM masjid";
      ...
      <div class="display: flex; justify-content: center">
        <div class="progress-bar-2"
          style="width: 100%; background-color: #999999; height: 45px; border-radius: 5px; overflow: hidden; text-align: center; ">
          <div class="progress-2" style=" width: <?php echo $bar ?? 0 ?>%;"></div>
          <span class="progress-text-2"
            style="position: absolute; padding-top: 83px;  transform: translate(-50%, -50%); color: white; text-align: center; ">
            <?php echo '<h1 style="color:black">' . $bar . '%<h1>'; ?>
          </span>
        </div>
      </div>
    </div>
    <div class="section-2">
      <div class="spinning-text-2" id="spinning-text">
        <marquee class="text-jalan" behavior="scroll" direction="left" scrolLamount="30" style=" ">
          <?php foreach ($all_data as $data): ?>
            <h3 style="display: inline;  color: white; padding-right: 20px; ">
              <?= $data['nama_donatur'] ?> -
            </h3>
            <h3 style="color: #FFF500; display: inline; padding-right: 20px;  ">
              <?= $data['kategori'] ?>
    ...
    <div id="manfaat">
      <div class="content-isi">
        <div class="text1">
          <h1><span class="spann">Manfaat </span>Wakaf, infaq<br> shodaqoh.</h1><br>
          <p class="kata-2">Berikut adalah beberapa keutamaan wakaq, infaq shodaqoh yang akan anda dapatkan.</p><br><br>
        </div>
      </div>
    </div>
    <div class="card1">
      <img src="img/foto-love.png" alt="Logo" class="logo1">
    ...
    <div class="card1">
      <img src="img/foto-ceklis-kotak.png" alt="Logo" class="logo1">
      <div class="name-1">Menjauhkan dari bahaya</div>
      <div class="contact-1">
        Rasulullah SAW pernah bersabda: “Bersegeralah untuk bersedekah, karena musibah dan bencana tidak bisa mendahului
        sedekah."
      </div>
    </div>

    <div class="card1">
      <img src="img/foto-ceklis-bulat.png" alt="Logo" class="logo1">
    ...
    <div class="card1">
      <img src="img/bintang-2-foto.png" alt="Logo" class="logo1">
    ...
    <div id="cara_melakukan">
      <div class="content-isi">
        <br><br><br><br>
        <div class="text1">
          <h1><span class="spann">Cara Melakukan </span> Wakaf, infaq <br> shodaqoh.</h1><br>
          <p class="kata-2">Berikut adalah Cara melakukan wakaq, infaq shodaqoh untuk membantu pembangunan masjid besar
            SMK Bogor</p><br><br><br>
        </div>
      </div>
    </div>
    <div class="card2">
    ...
    <div id="data">
      <div class="content-isi">
        <br><br><br><br>
        <div class="text1">
          <h1><span class="spann">Data donatur </span> Wakaf, infaq <br> shodaqoh.</h1><br>
          <p class="kata-2">Berikut adalah data donatur wakaf, infaq shodaqoh untuk masjid besar SMK Wikrama Bogor</p>
          <br><br><br>
        </div>
        <table class="table">
          <thead>
    ...
    <div id="galeri">
      <div class="content-isi">
        <div class="text1"><br><br><br><br>
          <h1><span class="spann">Gallery </span> Masjid Besar SMK <br> Wikrama Bogor.</h1><br>
    ...
    <div class="card-container5" > 
      ...
      <div class="card5" style="border-radius: 20px;">
        <img src="img/masjid-air.png">
      </div>
      <div class="card5" style="border-radius: 20px;">
        <img src="img/masjid-cerah-malam.png">
      </div>
      <div class="card5" style="border-radius: 20px;">
        <img src="img/masjid-cerah.png">
      </div>
      <div class="card5" style="border-radius: 20px;">
        <img src="img/masjid2.jpg">
      </div>
      <div class="card5" style="border-radius: 20px;">
        <img src="img/masjid-putih.png">
      </div>
  </section>
